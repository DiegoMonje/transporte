...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og.png", width: 1200, height: 630, alt: "Transporte directo para empresas en Sevilla" }],
  },
  twitter: { card: "summary_large_image", title: "Transporte directo para empresas en Sevilla", description: "Recogida, transporte directo y entrega con vehículo exclusivo para empresas.", images: ["/og.png"] },
...
const jsonLd = {
  ...
  image: "https://transporte-directo-sevilla.vercel.app/og.png",
